...
|-------|-------------|-------|
| Pipelines (DLT/SDP) | `https://<host>/api/2.0/pipelines` | Create, get, list, update, delete, start_update, stop, list_updates, events |
| Pipeline updates | `https://<host>/api/2.0/pipelines/{id}/updates` | Poll update status |

SDK: `w.pipelines` from `databricks.sdk.service.pipelines`.
