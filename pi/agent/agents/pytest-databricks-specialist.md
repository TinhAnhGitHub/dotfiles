---
name: pytest-databricks-specialist
description: >-
  ...
  configuration, PySpark DataFrame tests, Databricks Connect tests, dbutils/Spark mocking,
  and databricks-labs-pytester integration tests. Always uses the pytest-databricks skill.
systemPromptMode: replace
inheritProjectContext: true
inheritSkills: true
tools: read, grep, find, ls, bash, edit, write, mcp, subagent, contact_supervisor
skills: pytest-databricks
---
