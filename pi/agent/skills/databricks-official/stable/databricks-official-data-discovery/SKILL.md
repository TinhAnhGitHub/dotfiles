---
name: databricks-official-data-discovery
...
Genie One just needs an authenticated CLI profile (the parent `databricks-official-core`
...
commands — see **[Manual Data Exploration](../databricks-official-core/manual-data-exploration.md)**
