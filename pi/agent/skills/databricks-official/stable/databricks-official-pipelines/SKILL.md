---
name: databricks-official-pipelines
...
**FIRST**: Use the parent `databricks-official-core` skill for CLI basics, authentication, profile selection, and data discovery commands.
