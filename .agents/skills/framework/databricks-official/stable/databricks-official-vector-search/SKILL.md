---
name: databricks-official-vector-search
...
Storage-Optimized endpoints use SQL-like filter syntax via the `databricks-official-vectorsearch` package's `filters` parameter (accepts a string):
...
| **filters_json not working** | Storage-Optimized uses SQL-like string filters via `databricks-official-vectorsearch` package's `filters` parameter |
...
|-------|------------|----------------|----------|
| `databricks-official-gte-large-en` | 1024 | 8192 tokens | English text, high quality |
| `databricks-official-bge-large-en` | 1024 | 512 tokens | English text, general purpose |
...
- **Filter syntax differs by endpoint** — Standard uses dict-format filters, Storage-Optimized uses SQL-like string filters. Use the `databricks-official-vectorsearch` package's `filters` parameter which accepts both formats
...
- **[databricks-agent-bricks](../databricks-official-agent-bricks/SKILL.md)** - Knowledge Assistants use RAG over indexed documents
- **[databricks-unstructured-pdf-generation](../databricks-official-unstructured-pdf-generation/SKILL.md)** - Generate documents to index in Vector Search
- **[databricks-unity-catalog](../databricks-official-unity-catalog/SKILL.md)** - Manage the catalogs and tables that back Delta Sync indexes
