---
name: databricks-official-genie-agents
...
A Genie Agent is a **curated agent scoped to specific data** — its tables, sample questions, and instructions are authored for a particular business area. This is distinct from **Genie One** / the general "ask Genie" data-discovery path (see the `databricks-official-data-discovery` skill), which answers questions across your data without a curated, per-scope agent.
...
> this — route to the **[databricks-data-discovery](../databricks-official-data-discovery/SKILL.md)**
...
- **[databricks-data-discovery](../databricks-official-data-discovery/SKILL.md)** - General natural-language data exploration / "ask Genie" (Genie One) across your data; use it when you are not targeting a specific curated Genie Agent
- **[databricks-synthetic-data-gen](../databricks-official-synthetic-data-gen/SKILL.md)** - Generate data for Genie tables
- **[databricks-pipelines](../databricks-official-pipelines/SKILL.md)** - Build bronze/silver/gold tables
