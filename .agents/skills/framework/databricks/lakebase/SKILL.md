...
|-------|-------------|-------|
| Database projects | `https://<host>/api/2.0/database/` | Create, get, list, update, delete projects |
| Branches | `https://<host>/api/2.0/database/{project}/branches` | Create, get, list, delete branches |
| Endpoints | `https://<host>/api/2.0/database/{project}/branches/{branch}/endpoints` | Create, get, list, update, delete endpoints |
| Credentials | `https://<host>/api/2.0/database/{project}/branches/{branch}/endpoints/{endpoint}/credentials` | Generate database credentials |
| Synced tables | `https://<host>/api/2.0/database/{project}/synced-database-tables` | Create, get, list, update, delete synced tables |

SDK: `w.postgres` from `databricks.sdk.service.postgres`.
