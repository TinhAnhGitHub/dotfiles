...
pin down, or generating a query from a question, prefer the `databricks-official-data-discovery`
...
| Exploring tables/schemas | [Manual Data Exploration](manual-data-exploration.md) (or `databricks-official-data-discovery` if installed) |
