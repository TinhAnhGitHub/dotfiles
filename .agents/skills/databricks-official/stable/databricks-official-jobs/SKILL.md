...
**FIRST**: Use the parent `databricks-official-core` skill for CLI basics, authentication, profile selection, and data exploration commands.
...
Read the `databricks-official-core` skill for CLI basics, authentication, and deployment workflow.
Read the `databricks-official-jobs` skill for job-specific guidance.
