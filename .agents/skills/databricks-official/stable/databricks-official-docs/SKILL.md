...
1. Load `databricks-official-spark-declarative-pipelines` skill for workflow patterns
...
- **[databricks-python-sdk](../databricks-official-python-sdk/SKILL.md)** - SDK patterns for programmatic Databricks access
- **databricks-pipelines** - DLT / Lakeflow pipeline workflows
- **[databricks-unity-catalog](../databricks-official-unity-catalog/SKILL.md)** - Governance and catalog management
- **databricks-model-serving** - Serving endpoints and model deployment
- **[databricks-mlflow-evaluation](../databricks-official-mlflow-evaluation/SKILL.md)** - MLflow 3 GenAI evaluation workflows
