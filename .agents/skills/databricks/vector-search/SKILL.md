...
|-------|-------------|-------|
| Vector search endpoints | `https://<host>/api/2.0/vector-search/endpoints` | Create, get, list, delete endpoints |
| Vector search indexes | `https://<host>/api/2.0/vector-search/indexes` | Create, get, query, sync, upsert, delete indexes |
| Permissions | `https://<host>/api/2.0/permissions` | Generic permissions API |

SDK: `w.vector_search_endpoints` and `w.vector_search_indexes` from `databricks.sdk.service.vectorsearch`.
