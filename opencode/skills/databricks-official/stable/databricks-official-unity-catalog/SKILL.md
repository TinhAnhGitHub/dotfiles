---
name: databricks-official-unity-catalog
...
- **[databricks-metric-views](../databricks-official-metric-views/SKILL.md)** — metric view definitions / DDL (`WITH METRICS LANGUAGE YAML`)
- **[databricks-iceberg](../databricks-official-iceberg/SKILL.md)** — Managed Iceberg, External Iceberg Reads (fka Uniform), and **Iceberg REST Catalog (IRC) credential *vending*** for external engines — distinct from UC storage credentials (see [references/2-external-locations.md](references/2-external-locations.md))
- **[databricks-ml-training](../databricks-official-ml-training/SKILL.md)** — UC model registration and `@prod`/`@challenger` aliases
- **[databricks-vector-search](../databricks-official-vector-search/SKILL.md)** — Vector Search indexes
- **[databricks-pipelines](../databricks-official-pipelines/SKILL.md)**, **[databricks-jobs](../databricks-official-jobs/SKILL.md)**, **[databricks-lakeflow-connect](../databricks-official-lakeflow-connect/SKILL.md)** — *producing* tables via pipelines/jobs/managed ingestion
- **[databricks-lakebase](../databricks-official-lakebase/SKILL.md)** — Lakebase / synced tables (OLTP)
- **[databricks-ai-functions](../databricks-official-ai-functions/SKILL.md)** — AI functions such as `ai_mask` / `ai_classify` (AI *transforms*, **not** access control — see [references/4-fine-grained-access.md](references/4-fine-grained-access.md))
- **[databricks-aibi-dashboards](../databricks-official-aibi-dashboards/SKILL.md)** — AI/BI dashboards on UC data
- **[databricks-synthetic-data-gen](../databricks-official-synthetic-data-gen/SKILL.md)** — generating data stored in UC volumes
