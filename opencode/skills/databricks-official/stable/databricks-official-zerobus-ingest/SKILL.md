---
name: databricks-official-zerobus-ingest
...
Databricks provides Spark, pandas, numpy, and common data libraries by default, but the Zerobus SDK is **never pre-installed** — always add `databricks-official-zerobus-ingest-sdk` to the job/cluster library config. Only add other libraries if you hit an import error.
...
- **[databricks-python-sdk](../databricks-official-python-sdk/SKILL.md)** - General SDK patterns and WorkspaceClient for table/schema management
- **databricks-pipelines** - Downstream pipeline processing of ingested data
- **[databricks-unity-catalog](../databricks-official-unity-catalog/SKILL.md)** - Managing catalogs, schemas, and tables that Zerobus writes to
- **[databricks-synthetic-data-gen](../databricks-official-synthetic-data-gen/SKILL.md)** - Generate test data to feed into Zerobus producers
