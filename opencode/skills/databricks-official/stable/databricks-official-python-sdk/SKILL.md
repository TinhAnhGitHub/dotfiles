---
name: databricks-official-python-sdk
...
Use `databricks-official-connect` for running Spark code locally against a Databricks cluster.
...
- **[databricks-unity-catalog](../databricks-official-unity-catalog/SKILL.md)** - catalog governance
- **databricks-model-serving** - serving endpoint management
- **[databricks-vector-search](../databricks-official-vector-search/SKILL.md)** - vector index operations
