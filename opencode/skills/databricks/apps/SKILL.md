...
|-------|-------------|-------|
| Apps | `https://<host>/api/2.0/apps` | Create, get, list, update, delete, start, stop, deploy |
| App deployments | `https://<host>/api/2.0/apps/{name}/deployments` | Deployment status and history |
| App event log | `https://<host>/api/2.0/apps/{name}/event-log` | App lifecycle events |

SDK: `w.apps` from `databricks.sdk.service.apps`.
